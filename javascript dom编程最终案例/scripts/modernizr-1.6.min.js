window.Modernizr = function(i, e, u) {
    ...
    function S() {
        f.input = function(a) {
            for (var b = 0,
            c = a.length; b < c; b++) L[a[b]] = !!(a[b] in h);
            return L
    ...
    Q = function(a) {
        ...
        b.textContent = a + "{#modernizr{height:3px}}"; (e.head || e.getElementsByTagName("head")[0]).appendChild(b);
        c.id = "modernizr";
        l.appendChild(c);
        a = c.offsetHeight === 3;
    ...
    d.flexbox = function() {
        ...
        b = e.createElement("div"); (function(k, g, r, x) {
            g += ":";
